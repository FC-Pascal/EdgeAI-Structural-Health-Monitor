/*
 * File: _coder_predict_fault_mex.c
 *
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&predict_fault_atexit);
  /* Module initialization. */
  predict_fault_initialize();
  /* Dispatch the entry-point. */
  unsafe_predict_fault_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
                                      ...
                                      int32_T nrhs, const mxArray *prhs[1])
{
  ...
  /* Call the function. */
  predict_fault_api(prhs[0], &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_predict_fault_mex.c
 *
 * [EOF]
 */
